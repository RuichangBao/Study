...
public class ColorPick : MonoBehaviour
{
    ...
    private void UpdateStauration()
    {
        ...
        //Saturation_Sprite = Saturation.sprite;
        ...
        for (int y = 0; y <= sHeight; y++)
        {
            ...
            {
                Color pixColor = GetSaturation(currentHue, x / sWidth, y / sHeight);
    ...
    {
        Vector2 size2 = Saturation.rectTransform.sizeDelta / 2;
    ...
    {
        float h = Hue.rectTransform.sizeDelta.y / 2.0f;
        float y = Mathf.Clamp(sender.ClickPoint.y, -h, h);
